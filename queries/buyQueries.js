...
buyQueries.loadAllFrom    = function loadAllFrom(start,end) {
                                     var base = "Select title,first_name,last_name, author, ISBN, price, listingId From (Select * From Listing Where Listing.IsSold = 'F') Natural Join Item Natural Join Account Where ";
                                     //empty inputs
                                     if(!start && !end){
